...
using all_backends_mux =
        io::multiplexing_transport<unix_transport, asio_transport, tls::tls_transport,
...
[[nodiscard]] inline all_backends_mux
make_all_backends_mux(unix_transport &local, asio_transport &remote, tls::tls_transport &secure,
...
static_assert(
        plexus::io::transport_backend<plexus::asio::all_backends_mux,
