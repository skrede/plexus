...
using all_backends_mux_shm =
        io::multiplexing_transport<shm_member, unix_transport, asio_transport, tls::tls_transport,
...
[[nodiscard]] inline all_backends_mux_shm
make_all_backends_mux_shm(shm_member &shm, unix_transport &local, asio_transport &remote,
                          tls::tls_transport &secure, udp_transport &datagram,
...
static_assert(
        plexus::io::transport_backend<plexus::asio::shm::all_backends_mux_shm,
