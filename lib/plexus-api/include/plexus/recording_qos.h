...
// count_n is the clock-free opt-out. The numeric decimation/window_ns are placeholders here,
// not tuned values. fidelity defaults to off, so a recording_qos a consumer leaves alone
// SELECTS NOTHING — declaring no recording QoS ships zero capture.
