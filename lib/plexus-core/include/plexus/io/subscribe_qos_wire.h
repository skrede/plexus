...
{
    return subscriber_qos{.durability_mode                = static_cast<durability>(r.durability),
                          .delivery_mode                  = static_cast<delivery>(r.delivery_mode),
                          .replay_depth                   = r.replay_depth,
                          .requires_source_identity       = (r.requested_flags & wire::detail::k_qos_flag_requires_source_identity) != 0,
                          .requested_reliability_reliable = (r.requested_flags & wire::detail::k_qos_flag_requested_reliable) != 0,
                          ...
                          .rxo                            = (r.requested_flags & wire::detail::k_qos_flag_rxo_strict) != 0 ? rxo_mode::strict : rxo_mode::permissive,
                          .posture                        = (r.requested_flags & wire::detail::k_qos_flag_typed_strict) != 0 ? attach_posture::strict : attach_posture::lenient};
}
