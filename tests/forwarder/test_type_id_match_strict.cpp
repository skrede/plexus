...
TEST_CASE("strict posture: the typed-strict bit round-trips through the wire region", "[forwarder][type_id][strict]")
{
    ...
    CHECK(plexus::io::from_wire_region(lenient_region).posture == plexus::io::attach_posture::lenient);
}
