...
// The frame is the WIDENED layout (the appended same-host fingerprint): the decoders
...
// field because it decodes raw bytes, but the wider decode is exactly what it covers.
