...
struct identity_fixture
{
    ...
    {
        dir = std::filesystem::temp_directory_path() / ("plexus_tlsbp_" + tag + "_" + std::to_string(plexus::testing::process_id()) + "_" + std::to_string(reinterpret_cast<std::uintptr_t>(this)));
