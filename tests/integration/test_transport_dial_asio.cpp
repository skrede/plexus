...
TEST_CASE("asio transport: a DIALED peer_session pair completes the handshake over real TCP and "
          "mints epochs, looped",
...
TEST_CASE("asio transport: a real published message carrying the minted epoch flows post-dial over "
          "TCP, looped",
          "[integration][transport][asio]")
{
    constexpr int     k_iterations = 100;
