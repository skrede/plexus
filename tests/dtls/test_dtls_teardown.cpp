...
TEST_CASE("dtls.teardown: an inbound datagram after the engine destroys a completed accepted "
...
TEST_CASE("dtls.teardown: a consumer that destroys the channel in on_closed survives the "
          "close_notify, looped",
          "[dtls][teardown]")
{
