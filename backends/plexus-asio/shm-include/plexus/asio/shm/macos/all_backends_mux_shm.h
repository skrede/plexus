#ifndef HPP_GUARD_PLEXUS_ASIO_SHM_MACOS_ALL_BACKENDS_MUX_SHM_H
#define HPP_GUARD_PLEXUS_ASIO_SHM_MACOS_ALL_BACKENDS_MUX_SHM_H

#include "plexus/asio/shm/macos/shm_member.h"
